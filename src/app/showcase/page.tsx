  ...
  return (
    <main className="overflow-hidden pb-24">
      <section className="relative px-5 pb-20 pt-16 sm:px-8 lg:px-12 lg:pb-28 lg:pt-24">
        <div className="absolute left-[8%] top-10 size-72 rounded-full bg-[var(--yellow)]/25 blur-3xl" />
